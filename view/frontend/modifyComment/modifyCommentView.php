...
<a href="index.php?controler=frontend&action=post&post_id=<?= $post->post_id() ?>">Retour à l'article</a>
    ...
    <div>
        ...
        <form action="index.php?controleur=frontend&action=modifyComment&amp;post_id=<?= $post->post_id() ?>&amp;comment_id=<?= $toModifyComment->comment_id() ?><?php if (isset($oldAction)){echo '&oldAction=' . $oldAction;} ?>" method="post">
